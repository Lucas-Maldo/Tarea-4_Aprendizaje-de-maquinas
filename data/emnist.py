...
if __name__ == '__main__' :
    ...
    fimages = os.path.join(base_dir, 'emnist-letters-test-images-idx3-ubyte\emnist-letters-test-images-idx3-ubyte')
    limages = os.path.join(base_dir, 'emnist-letters-test-labels-idx1-ubyte\emnist-letters-test-labels-idx1-ubyte')    
